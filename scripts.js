// ----------------------------- DATA MODELS -----------------------------
const JOBS_DATA = [
  {title:"Customer Service Representative", category:"Support", desc:"Provide white-glove support, handle inquiries, and ensure client delight.", resp:"Answer calls/emails, resolve issues, maintain CRM.", req:"Excellent communication skills and a passion for helping people."},
  {title:"Administrative Assistant", category:"Administration", desc:"Support daily operations, schedule coordination, and document management.", resp:"Calendar management, vendor communication, inventory logs.", req:"Basic computer proficiency and strong organizational skills."},
  {title:"Warehouse Associate", category:"Logistics", desc:"Manage jewelry inventory, packing, and quality checks.", resp:"Pick/pack orders, inspect pieces, maintain stock.", req:"Reliability, following instructions, and a keen eye for detail."},
  {title:"Customer Experience Researcher", category:"Research", desc:"Conduct user research and analyze customer feedback to improve the overall customer experience.", resp:"Plan and conduct user interviews, surveys, and usability tests. Analyze data and create reports.", req:"Experience with user research methodologies and data analysis."},
  {title:"Bookkeeper/Cashier", category:"Finance", desc:"Handle financial records, cash reconciliation, and invoices.", resp:"AP/AR, sales tracking, bank reconciliations.", req:"Numerical accuracy and familiarity with basic financial software."}
];
...
function jobsPage() {
  const listItems = JOBS_DATA.map(r => `
...
function applyPage() {
  return `<div class="container fade-up"><section><h1 class="section-title">Apply to Lumina</h1><div class="form-container"><form id="job-application-form">
    ...
    <div class="form-group"><label>Position Applying For *</label><select id="position" required><option value="">Select role</option><option>Customer Service Representative</option><option>Administrative Assistant</option><option>Warehouse Associate</option><option>Customer Experience Researcher</option><option>Bookkeeper/Cashier</option></select></div>
